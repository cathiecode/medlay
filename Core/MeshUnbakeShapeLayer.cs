namespace com.superneko.medlay.Core
{
    ...
    internal class MeshUnbakeMeshEditLayerProcessor : MeshEditLayerProcessor<MeshUnbakeMeshEditLayer>
    {
        ...
        {
            meshBakeProcessor.UnBakeMeshFromBase(
                context.WritableMeshData,
                context.OriginalRenderer,
                context.Bones,
                context.WorldToBaseMatrix,
                new MeshBakeProcessor.Assumptions {
                    boneMatricesAreNotChanged = !context.BoneIsChanged
                });
        }
    }
}
